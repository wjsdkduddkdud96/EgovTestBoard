...
public class EgovLoginController {
	...
	public String actionSecurityLogin(@ModelAttribute("loginVO") LoginVO loginVO, HttpServletResponse response, HttpServletRequest request, ModelMap model) throws Exception {
		...
		if (resultVO != null && resultVO.getId() != null && !resultVO.getId().equals("") && loginPolicyYn) {
			...
			request.getSession().setAttribute("LoginVO_id", resultVO.getId());
			request.getSession().setAttribute("LoginVO_name", resultVO.getName());
	...
	public String actionLogout(HttpServletRequest request, ModelMap model) throws Exception {
		...
		LOGGER.info("Session : " + request.getSession().getAttribute("LoginVO"));
