...
public interface EgovBBSManageService {
	...
	public Map<String, Object> selectTestBoard(TestBoard testBoard)
	  throws Exception;

	public void insertTestBoard(TestBoard testBoard)
	  throws Exception;

	public Map<String, Object> registTestBoard(TestBoard testBoard)
	  throws Exception;
	...
	public void replyTestBoard(TestBoard testBoard)
			throws Exception;
