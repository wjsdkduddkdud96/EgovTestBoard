            ...
            <div id="content">
                ...
                <div class="default_tablestyle">
                    ...
                    <c:forEach items="${selectTest }" var="item" varStatus="status">
                		<tr>
                			<td>${status.count }</td>
                			<td><a class="testBoardSub" href='<c:url value="/cop/bbs/registTestBoard.do"/>?testBoard_idx=<c:out value="${item.testBoard_idx }"/>'>${item.testBoard_subject }</a></td>
                			<td>${item.testBoard_id }</td>
