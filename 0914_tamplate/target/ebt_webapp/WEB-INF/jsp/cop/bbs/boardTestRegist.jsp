    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <c:forEach items="${registTest }" var="item" varStatus="status">
                <form name="frm" method="post" action="<c:url value='/cop/bbs/registTestBoard.do'/>">
                        ...
                        <table>
                          ...
                          <tr> 
                            ...
                            <td width="85%" colspan="5" nowrap="nowrap">
                            	<input style="border: 0px" type="text" name="testBoard_subject" value="<c:out value='${item.testBoard_subject}' />" readonly/>
                            	<input type="hidden" name="testBoard_idx" value="<c:out value='${item.testBoard_idx}' />"/>
                            </td>
                          </tr>
                          <tr> 
                            <th width="15%" height="23" nowrap >작성자</th>
                            <td width="15%" nowrap="nowrap">
                            <c:out value="${item.testBoard_id}" />
                            <%-- <c:choose>
                            ...
                            <td width="15%" nowrap="nowrap"><c:out value="${item.testBoard_date}" />
                            </td>
                            <th width="15%" height="23" nowrap >조회수</th>
                            <td width="15%" nowrap="nowrap"><c:out value="${item.testBoard_hits}" />
                            </td>
                          </tr>    
                          <tr> 
                            <th height="23" >글내용</th>
                            <td colspan="5">
                             <div id="bbs_cn">
                               <textarea id="testBoard_content" name="testBoard_content"  cols="75" rows="20"  style="width:99%; resize:none;" readonly="readonly" title="글내용"><c:out value="${item.testBoard_content}" escapeXml="true" /></textarea>
                             </div>
                            </td>
                          </tr>
                    ...
                    <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                      ...
                      <table border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                         <c:if test="${item.testBoard_id == sessionScope.LoginVO_name}">     
                              <td>
