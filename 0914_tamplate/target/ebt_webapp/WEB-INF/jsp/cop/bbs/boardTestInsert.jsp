                        ...
                        <table >
                            <tr>
                                ...
                                <td width="80%" nowrap colspan="3">
                                  <input id="testBoard_subject" name="testBoard_subject" type="text" size="60" value=""  maxlength="60" > 
                            ...
                            <tr> 
                                ...
                                <td colspan="3">
                                  <textarea id="testBoard_content" name="testBoard_content" class="textarea" cols="75" rows="20" style="width:99%; resize:none;"></textarea> 
